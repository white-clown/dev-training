...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sm_video: Schema.Attribute.Relation<'manyToOne', 'api::sm-video.sm-video'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEnrollEnroll extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Enrollment_status: Schema.Attribute.String;
    ...
    price: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    transactionUrl: Schema.Attribute.Media<'images'>;
...
export interface ApiPodcastPodcast extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audioUrl: Schema.Attribute.Media<'audios'>;
    author: Schema.Attribute.String;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    comments: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSmVideoSmVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_watched: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    likes: Schema.Attribute.Relation<'oneToMany', 'api::like.like'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sm-video.sm-video'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    ...
    video_list: Schema.Attribute.Relation<'manyToOne', 'api::video.video'>;
    views: Schema.Attribute.Relation<'oneToMany', 'api::view.view'>;
  };
}
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    courseInclude: Schema.Attribute.Component<
      'video-course.course-include',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    price: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    sm_videos: Schema.Attribute.Relation<'oneToMany', 'api::sm-video.sm-video'>;
    thumbNailImg: Schema.Attribute.Media<'images'>;
    title: Schema.Attribute.String;
    trailerUrl: Schema.Attribute.Media<'videos'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_users: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    enrolled_videos: Schema.Attribute.Relation<
      'manyToMany',
      'api::video.video'
    >;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    saveBlogs: Schema.Attribute.Relation<'manyToMany', 'api::blog.blog'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sm-video.sm-video': ApiSmVideoSmVideo;
